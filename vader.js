  ...
  */
  ...
  polarity_scores(text) {
    ...
    */
    ...
    for (let i = 0; i < words_and_emoticons.length; i++) {
      ...
      sentiments = new SentimentIntensityAnalyzer().sentiment_valence(
        valence,
        sentiText,
        item,
        i,
    ...
    sentiments = new SentimentIntensityAnalyzer().but_check(words_and_emoticons, sentiments);
    const valence_dict = new SentimentIntensityAnalyzer().score_valence(sentiments, text);
    return valence_dict;
  }
  ...
  punctuation_emphasis(sum_s, text) {
    ...
    */
    ...
    const ep_amplifier = new SentimentIntensityAnalyzer().amplify_ep(text);
    const qm_amplifier = new SentimentIntensityAnalyzer().amplify_qm(text);
  ...
  score_valence(sentiments, text) {
    if (sentiments && sentiments.length > 0) {
      ...
      const punct_emph_amplifier = new SentimentIntensityAnalyzer().punctuation_emphasis(sum_s, text);
      if (sum_s > 0) {
      ...
      let scores = new SentimentIntensityAnalyzer().sift_sentiment_scores(sentiments);
